{{-- resources/views/jenis_obat/index.blade.php --}}
@extends('layouts.app')
...
@section('content')
    <style>
        ...
        .mx-tbl tbody tr:hover .mx-count-chip {
    ...
    <div class="mx">
        ...
        <div class="mx-header">
            <div>
                ...
                <div class="mx-title">Jenis Obat</div>
                <div class="mx-sub">Kelola kategori / jenis obat yang tersedia</div>
            </div>
            <a href="{{ route('master.jenis-obat.create') }}" class="mx-btn-add">
        ...
        <div class="mx-stat-row">
            <div class="mx-stat-pill">
                ...
                <div>
                    ...
                    <div class="mx-stat-lbl">Total Jenis</div>
                </div>
            </div>
        </div>
        ...
        <div class="mx-card">
            <div class="mx-card-top">
                <div class="mx-card-top-left">
                    ...
                    <div>
                        <div class="mx-card-title">Daftar Jenis Obat</div>
                    </div>
                </div>
                <div style="display:flex;align-items:center;gap:10px;">
                    <span class="mx-card-badge">{{ $data->total() }} jenis</span>
                    <div class="mx-search-wrap">
                        ...
                        <input type="text" class="mx-search" placeholder="Cari jenis..." id="mxSearch"
            ...
            @if ($data->isEmpty())
                <div class="mx-empty">
                    ...
                    <div class="mx-empty-title">Belum ada jenis obat</div>
                    <div class="mx-empty-sub">Tambahkan kategori jenis obat terlebih dahulu</div>
                </div>
            @else
                    ...
                    <table class="mx-tbl" id="mxTable">
                        <thead>
                            <tr>
                                <th width="50">#</th>
                                <th>Nama Jenis</th>
                                <th class="thc" width="140">Jumlah Obat</th>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr style="animation-delay:{{ $loop->index * 0.04 }}s">
                                    ...
                                    <td>
                                        <span class="mx-row-dot"></span>
                                        <span class="mx-name" style="display:inline-flex;">{{ $item->nama_jenis }}</span>
                                    </td>
                                    <td class="tdc">
                                        <a href="{{ route('master.obat.index', ['jenis' => $item->id_jenis]) }}"
                                            class="mx-count-chip" title="Lihat obat jenis {{ $item->nama_jenis }}">
                                            {{ $item->obat_count }}
                                        </a>
                                    </td>
                                    <td class="tdc">
                                        <div class="mx-actions">
                                            <a href="{{ route('master.jenis-obat.edit', $item->id_jenis) }}"
                                                class="mx-btn-edit">
                                            ...
                                            <form action="{{ route('master.jenis-obat.destroy', $item->id_jenis) }}"
                                                method="POST" onsubmit="return confirm('Yakin hapus jenis ini?')">
                                                @csrf @method('DELETE')
